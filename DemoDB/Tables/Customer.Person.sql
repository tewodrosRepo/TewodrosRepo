...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Person__Modified__5165187F] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Person] ADD CONSTRAINT [PK__Person__543B4487045CA59F] PRIMARY KEY CLUSTERED  ([person_ID]) ON [PRIMARY]
GO
