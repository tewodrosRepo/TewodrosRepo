...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Address__Modifie__5441852A] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Address] ADD CONSTRAINT [PK__Address__091C2A1BE324779A] PRIMARY KEY CLUSTERED  ([AddressID]) ON [PRIMARY]
GO
